return {
            ...
            require("kanagawa").setup({
                ...
                overrides = function(colors)
                    ...
                    return {
                        ...
                        ["@markup.heading.1.markdown"] = { link = "@ibl.scope.char.1" },
                        ["@markup.heading.2.markdown"] = { link = "@ibl.scope.char.2" },
                        ["@markup.heading.3.markdown"] = { link = "@ibl.scope.char.3" },
                        ["@markup.heading.4.markdown"] = { link = "@ibl.scope.char.4" },
                        ["@markup.heading.5.markdown"] = { link = "@ibl.scope.char.5" },
                        ["@markup.heading.6.markdown"] = { link = "@ibl.scope.char.6" },
    ...
    },
    {
        ...
        "catppuccin/nvim",
        name = "catppuccin",
        lazy = false, -- do not load plugin unless needed
        -- enabled = false, -- disable plugin
        -- priority = 1000, -- make sure to load this before all the other start plugins
        ...
        config = function()
            ...
            -- vim.api.nvim_command("colorscheme catppuccin") -- load colorscheme
        end
    },
    {
        -- Alternative colorscheme
