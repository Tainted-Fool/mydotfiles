    ...
    config = function()
        ...
        autolist.setup({
            ...
            keymap(
                ...
                { desc = "AutolistShiftTab", noremap = true, silent = true }
            ),
            ...
            -- keymap("i", "<cr>", "<CR><cmd>AutolistNewBullet<cr>", {desc = "AutolistNewBullet", noremap = true, silent = true}), -- conflicts with nvim-autopairs see fix below
            ...
            keymap(
                ...
                { desc = "AutolistNewBullet", noremap = true, silent = true }
            ),
            keymap(
                "n",
                "O",
                "O<cmd>AutolistNewBulletBefore<cr>",
                { desc = "AutolistNewBulletBefore", noremap = true, silent = true }
            ),
            keymap(
                "n",
                "<cr>",
                "<cmd>AutolistToggleCheckbox<cr><cr>",
                { desc = "AutolistToggleCheckbox", noremap = true, silent = true }
            ),
            ...
            keymap(
                "n",
                "<leader>cn",
                "<cmd>AtuolistCycleNextDr<cr>",
                { desc = "AutolistCycleNextDr", noremap = true, silent = true, expr = true }
            ),
            keymap(
                "n",
                "<leader>cp",
                "<cmd>AtuolistCyclePrevDr<cr>",
                { desc = "AutolistCyclePrevDr", noremap = true, silent = true, expr = true }
            ),
            ...
            keymap(
                ...
                { desc = "AutolistRecalculate", noremap = true, silent = true }
            ),
            keymap(
                "n",
                "<<",
